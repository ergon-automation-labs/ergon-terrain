defmodule BotArmyTerrain.Schemas.Card do
  ...
  def changeset(card, attrs) do
    ...
    |> validate_inclusion(:card_type, ~w(basic cloze definition),
      message: "must be basic, cloze, or definition"
    )
    |> validate_inclusion(:state, ~w(new learning review suspended),
      message: "must be new, learning, review, or suspended"
    )
    |> set_next_review_at()
  end
